...
namespace CaseControl
{
    internal class Constants
    {
        ...
        internal const string DATABASE_BACKUP_FOLDER = "DB_Backup";
        ...
        internal const string INSERT_CLIENT_MASTER_QUERY = "INSERT INTO ClientMaster(FirstName,LastName,IsActive,ClientCreatedOn, ClientID) VALUES('{0}','{1}','{2}','{3}',{4})";
        ...
        internal const string EXISTS_CLIENT_ID_QUERY = "SELECT COUNT(1) FROM ClientFileMaster WHERE ClientID = (SELECT MAX(ClientID) FROM ClientMaster)";
        internal const string NEXT_CLIENT_ID_FROM_CLIENTFILEMASTER_QUERY = "SELECT ISNULL(MAX(ClientID),0) + 1 FROM ClientFileMaster";
        internal const string NEXT_CLIENT_ID_FROM_CLIENTMASTER_QUERY = "SELECT ISNULL(MAX(ClientID),0) + 1 FROM ClientMaster";

        internal const string NEW_FILE_ID_QUERY = "SELECT ISNULL(MAX(FileID),0) + 1 FROM ClientFileMaster ";
        ...
        internal const string DatabaseName = "CaseControlDB";
